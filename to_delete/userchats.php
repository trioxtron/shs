                    ...
                    if ($resultCheck > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            if ($row['creatorId'] == $_SESSION['userId']) {
                                echo "<tr><td>" . $row['creatorName'] . "</td><td>" . $row['creatorEmail'] . "</td><td><form method='post' action='chat.php?id=" . $row['coursId']
                                . "'><button class ='btn' type='submit' name='search-submit'>Chat öffnen</button></form></td></tr>";
                            }
                        }
                        echo "</tabel>";
                    }
