...
<div class="pt-40 px-8 container mx-auto flex flex-col-reverse justify-center items-center xl:flex-row">
    <div>
        <h1 class="font-bold text-4xl pb-4 xl:text-6xl">Unser Ziel:</h1>
