...
<div class="pt-6 px-8 container mx-auto flex flex-col-reverse justify-center items-center xl:flex-row">
    <div class="xl:pb-8 information">
        ...
        <h1 class="font-bold underline text-4xl pb-4 pt-8 xl:text-4xl">Fedor</h1>
        <p>Fedor, 16 Jahre ist zuständig für Organisation, Management und Idee Entwürfe.</p>
    ...
    <div class="hidden md:block">
        <img src="images/helmet.png" alt="planet" class="h-64 w-64 ml-16 xl:h-80 xl:w-80 xl:ml-24">
    </div>
</div>';
